          ...
          >
            ...
            <div className="col-span-5 mt-1.5">
              <div className="flex items-center">
                <Separator className="flex-auto bg-primary" /> <span className="mx-3.5">Or</span> <Separator className="flex-auto bg-primary" />
              </div>
            </div>
            <Button type="button" className="shadow-sm" variant={"secondary"}><img className="w-5 h-5" src={GoogleIcon} alt="google" /></Button>
          </form>
        </Form>
